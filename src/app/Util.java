...
public class Util {
    ...
    public static final String FRONT_END_HOST = "192.168.2.23";
    public static final String SEQUENCER_HOST = "192.168.2.23";
    public static final String[] REPLICA_HOSTS = new String[]{"192.168.2.23", "192.168.2.23", "192.168.2.23", "192.168.2.23"};
