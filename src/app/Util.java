...
public class Util {
    ...
    public static final String FRONT_END_HOST = "192.168.2.13";
    public static final String SEQUENCER_HOST = "192.168.2.13";
    public static final String[] REPLICA_HOSTS = new String[]{"192.168.2.13", "192.168.2.13", "192.168.2.13", "192.168.2.13"};
