...
/**
* app/student/StudentPOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from App.idl
* Wednesday, November 8, 2017 12:33:45 AM EST
*/

public abstract class StudentPOA extends org.omg.PortableServer.Servant
 implements app.student.StudentOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getAvailableTimeSlots", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // app/student/Student/bookRoom
       {
       ...
       case 1:  // app/student/Student/getAvailableTimeSlots
       {
         String studentID = in.read_string ();
         String date = in.read_string ();
         String $result = null;
       ...
       case 2:  // app/student/Student/cancelBooking
       {
         String studentID = in.read_string ();
       ...
       case 3:  // app/student/Student/changeReservation
       {
         String studentID = in.read_string ();
         String bookingID = in.read_string ();
         String campusName = in.read_string ();
  ...
  public Student _this() 
  {
    return StudentHelper.narrow(
    super._this_object());
  }

  public Student _this(org.omg.CORBA.ORB orb) 
  {
    return StudentHelper.narrow(
